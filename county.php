...
<?php 
  ...
  {
    $RecordeLimit = 5;
    $searchState = mysqli_query($db,"select count(StateId) as total from counties ");
    $SName = mysqli_fetch_array($searchState);
    ...
    {
      $Skip = (intval($_GET["bn"]) * $RecordeLimit) - $RecordeLimit;
      $sql = mysqli_query($db,"select * from counties LIMIT $Skip,$RecordeLimit");
    }
    else
    {
      $sql = mysqli_query($db,"select * from counties LIMIT $RecordeLimit");
    }
...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Home</a><i class="fa fa-angle-right"></i>Table Master<i class="fa fa-angle-right"></i>County</li>
</ol>
