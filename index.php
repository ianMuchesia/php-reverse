...
<html>
<head>
<title>Login Page - Vigilantrides</title>
...
<style>
  ...
  body, .main-wthree {
    width: 100%;
    min-height: 100vh;
    background-image: url('images/bus.jpg'); /* Path to your background image */
...
<body>
	<div class="main-wthree">
		<div class="container">
			<h1 class="text-center text-white">Vigilantrides</h1>
		<div class="sin-w3-agile">
			...
			<form action="controller/login.php" method="post">
				...
				<div class="clearfix"></div>
				<h5 class="text-center"><a href="./user" class="text-white" >Login as a User</a></h5>
				<div class="clearfix"></div>
			</form>
					<!-- <div class="back">
					...
					<div class="footer">
						<p>Vigilant ltd. All Rights Reserved &copy; <?= date("Y") ?> </p>
					</div>
		</div>
		</div>
	</div>
