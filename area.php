...
<?php 
  ...
  if(isset($_GET['cityedit']))
  {
    ...
    $edit = mysqli_query($db,"select * from areas where CityId='$cityid'");
  ...
  {
    $RecordeLimit = 5;
    $searchCity = mysqli_query($db,"select count(CityId) as total from areas ");
    $CName = mysqli_fetch_array($searchCity);
    ...
    {
      $Skip = (intval($_GET["bn"]) * $RecordeLimit) - $RecordeLimit;
      $sql = mysqli_query($db,"select * from areas LIMIT $Skip,$RecordeLimit");
    }
    else
    {
      $sql = mysqli_query($db,"select * from areas LIMIT $RecordeLimit");
    }
            ...
            <div class="clearfix"> </div>
          	...
          	<div class="col-md-3 control-label">
            	<label class="control-label">Area</label>
              	...
              	<input type="text" name="city" placeholder="Area Name" value="<?php echo $name; ?>" required="" class="form-control" style="width: 250px; height: 35px;">
              	</div>
            </div>
            	<div class="clearfix"> </div>
        </div>
