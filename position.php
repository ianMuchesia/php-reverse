...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Home</a><i class="fa fa-angle-right"></i>Table Master<i class="fa fa-angle-right"></i>Ownership</li>
</ol>
        ...
        <h2>Add Ownership status</h2>
          	<div class="col-md-3 control-label">
            	<label class="control-label">Ownership</label>
              	...
              	<input type="text" name="position" required="" value="<?php echo $name; ?>"  placeholder="ownership type" class="form-control" style="width: 250px; height: 35px; float: right;">
              	</div>
            </div>
