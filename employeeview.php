...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Home</a><i class="fa fa-angle-right"></i>client<i class="fa fa-angle-right"></i>Driver View</li>
</ol>
...
<div class="validation-form">
 	<div>
		...
		<thead>
			<tr>
				<th style="text-transform: capitalize;">Driver's Photo</th>
				<th style="text-transform: capitalize;">Name</th>
				<th style="text-transform: capitalize; text-align: center;">Driver's Id</th>
